...
////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if (sin(g_long_radian - c_long_radian) < 0) {
                true_bearing = 360 - true_bearing;
                c_bearing = c_bearing + 65;
            }
            if (sin(g_long_radian - c_long_radian) > 0) {
                c_bearing = c_bearing + 65;
            }
...
///////////////////////////////////////////////////////////////////////////////////////////
            ...
            if (c_bearing >= 360) c_bearing = c_bearing - 360;

            if (true_bearing <  0  ) true_bearing = 360 + true_bearing;
            if (true_bearing >= 360) true_bearing = true_bearing - 360;
            ...
            if(sin(g_long_radian - c_long_radian) > 0 || dist > 7.0) {
            ...
            if (dist < 7.0 || true_bearing < c_bearing + 10 && true_bearing > c_bearing - 10 && dist > LIMITE_DIST)
